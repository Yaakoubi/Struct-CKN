...
parser.add_argument("--numberEpochsFW",
                    metavar='numberEpochsFW', type=int, default=10)
parser.add_argument("--numberEpochsCKN",
                    metavar='numberEpochsCKN', type=int, default=100)
parser.add_argument("--regParBCFW", metavar='regParBCFW',
                    type=float, default=1.)
parser.add_argument("--regParSDCA", metavar='regParSDCA',
...
parser.add_argument("--zero-prob", metavar='zero-prob',
