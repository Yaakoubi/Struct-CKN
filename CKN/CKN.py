...
class CKN(nn.Module):
    def __init__(self, dim1=28, dim2=28, n_components=[10, 10, 10], n_layers=3, n_patches=[5, 2, 2],
                 ...
                 batch_size=[100, 200, 500], iter_max=100, n_patches_per_graph=[30, 20, 20], use_cuda=True, lr=0.1):
    ...
    def train_network_sup(self, X, letters_y_train, clf, scaler, struct_model=None, X_train_words=None,
        ...
        if use_sdca4crf:
            ...
            dataset_filename_time_stamp = None
        if init:  # changed
            if use_embedding:
                if verbose:
        ...
        for t in range(numberEpochsCKN):
            ...
            if use_fw:
                ...
                X2_train, y2_train = write_mat_file(
                    ...
                    filename=dataset_filename_time_stamp)
                ...
                if t == 0 and init:
                    predicted_labels_train, optweights, optmargs = fit_sdca(
                        include_eos=False, filename=dataset_filename_time_stamp, xtrain=X2_train, ytrain=y2_train,
                    ...
                    predicted_labels_train, predicted_labels_test = predict_sdca(
                        optweights, train=True, test=True, include_eos=False, filename=dataset_filename_time_stamp,
